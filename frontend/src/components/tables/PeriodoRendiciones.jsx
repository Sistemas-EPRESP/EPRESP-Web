const PeriodoRendiciones = ({ selectedMonth }) => {
  const rows = [
    ...
    ["Septiembre", "1 a 31 de Agosto", "1 a 30 de Septiembre", "1 a 10 de Octubre"],
    ["Octubre", "1 a 30 de Septiembre", "1 a 31 de Octubre", "1 a 10 de Noviembre"],
    ["Noviembre", "1 a 31 de Octubre", "1 a 30 de Noviembre", "1 a 10 de Diciembre"],
    ["Diciembre", "1 a 30 de Noviembre", "1 a 31 de Diciembre", "1 a 10 de Enero"],
  ];
  ...
  return (
    <div className="mt-12 space-y-8">
      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Aclaraciones</h3>
        <ol className="list-[lower-alpha] pl-5 space-y-3 text-gray-700">
          <li>
            El "Periodo de Rendición" se corresponde con el mes de percepción de la factura, de acuerdo con el articulo
            7° del Anexo de la Res.N°38/2024 - EPRESP.
          </li>
          <li>
            La "Facturación" considerada como base e imponible es la correspondiente al mes anterior al "Periodo de
            Rendición".
          </li>
          <li>
            El importe en columna "Total Transferido" puede ser mayor que el de la columna "Total Percibido" debido a
            cobros de deudores morosos.
          </li>
        </ol>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="divide-y divide-gray-200">
            {rows.map((row, index) => {
              // Comparamos el número de mes (index + 1) con selectedMonth
              const isSelected = index + 1 === selectedMonth;
              return (
                <tr key={index} className={isSelected ? "bg-blue-100" : index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
